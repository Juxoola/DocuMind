...
def make_prompt(query: str, context_str: str) -> str:
    return (
        ...
        "- Пример правильного ответа: \"Интеллектуальная система — это система, способная к целенаправленному поведению [1]. "
        "Она включает подсистемы: диалог, рабочую память и решатель [1].\"\n"
        "- Если используешь информацию из нескольких файлов в одном предложении — ставь все номера: [1][2].\n"
        "- НИКОГДА не пиши абзац без [N] в конце.\n"
