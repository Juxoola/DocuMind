...
async def describe_image_with_lmstudio(
    ...
    prompt = """Опиши это изображение подробно и точно.

Если на изображении слайд/презентация/диаграмма/схема:
- Опиши заголовок
- Опиши структуру диаграммы: оси, ячейки, связи, содержимое каждой ячейки
- Приведи весь текст/определения/термины дословно
- Укажи логотипы, подписи, обозначения

Если фото/снимок:
- Что изображено: оборудование, люди, обстановка, действие
- Если есть текст — приведи дословно

Объём: исчерпывающе, без ограничения по длине. Лучше подробнее, чем короче."""
