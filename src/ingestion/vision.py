...
Если есть текст на изображении — приведи его дословно.
Если есть схема, диаграмма или таблица — опиши структуру и содержание.
Если видны компоненты/детали — перечисли и опиши каждый.

Объём: 3-7 предложений. Технический стиль, без воды."""
