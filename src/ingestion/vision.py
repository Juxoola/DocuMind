...
Слайд/презентация/диаграмма:
- Заголовок и подзаголовки
- Полный текст слайда дословно
- Структура диаграммы/схемы: все блоки, стрелки, связи, подписи
- Иерархия элементов, порядок следования
- Логотипы и обозначения

Фото:
- Что изображено
- Текст дословно, если есть

Не повторяй одну и ту же информацию дважды (таблица + текст). Описывай структуру связно, но исчерпывающе."""
