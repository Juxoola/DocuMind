...
async def describe_image_with_lmstudio(
    ...
    prompt = """Опиши это изображение. Избегай повторений — каждую информацию упомяни один раз.

Слайд/презентация/диаграмма:
- Заголовок
- Структура: оси, ячейки, связи (для диаграмм/таблиц)
- Весь текст/определения дословно
- Логотипы, подписи, обозначения

Фото:
- Что изображено кратко
- Текст дословно, если есть

Пиши по существу. Не создавай нумерованные списки-резюме и повторные сводки."""
